...
from nnunetv2.utilities.pruned_unet import PrunedConvUNet
...
class PrunedExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
                 gpu_memory_target_in_gb: float = 8,
                 preprocessor_name: str = 'DefaultPreprocessor', plans_name: str = 'nnUNetPrunedPlans',
        ...
        self.UNet_class = PrunedConvUNet
...
if __name__ == '__main__':
    PrunedExperimentPlanner(2, 8).plan_experiment()
